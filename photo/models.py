...
class Photo(models.Model):
	...
	title = models.CharField('상품명', max_length=50)
	price = models.CharField('상품 가격', max_length=50)
	condition = models.CharField('상품 상태', max_length=50, blank=True)
	country= models.CharField('원산지', max_length=50, blank=True)
